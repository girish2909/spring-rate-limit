...
import com.demo.spring.exceptions.RateLimitException;
...
public class RateLimitAspect {
    ...
    @Value("${APP_RATE_DURATIONINMS:#{5000}}")
     ...
     * If there have been more than {@link #rateLimit} calls within {@link #rateDuration} milliseconds from a remote address,
     ...
     */
    @Before("@annotation(com.demo.spring.annotation.WithRateLimitProtection)")
